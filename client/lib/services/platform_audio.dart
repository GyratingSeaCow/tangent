...
///
/// just_audio has no Linux or Windows implementation of its own: without
/// this every AudioPlayer call throws MissingPluginException and playback of
/// synced recordings is silently dead on desktop — exactly the kind of quiet
